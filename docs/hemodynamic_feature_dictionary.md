...
**x<sub>Rel</sub>(t) = [x(t) − μ<sub>base</sub>] / |μ<sub>base</sub>|**

where μ<sub>base</sub> denotes the mean value of the corresponding feature during the subject-specific baseline window.
